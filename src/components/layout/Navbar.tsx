      ...
      <div className="px-4 pt-3 md:px-8 md:pt-4">
        <nav className="tg-glass mx-auto flex max-w-6xl items-center justify-between gap-4 rounded-2xl px-4 py-3 md:px-6">
          <a
            ...
            className="font-[family-name:var(--font-heading)] text-sm font-bold tracking-tight md:text-base"
          >
            <span className="tg-gradient-text">TruthGuard</span>
            <span className="text-[#EAEAEA]/90"> News AI</span>
          </a>
